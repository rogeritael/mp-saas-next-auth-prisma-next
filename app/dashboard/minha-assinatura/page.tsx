...
import { CreditCard, HandCoins, XCircle } from 'lucide-react';
    ...
    <Card className="w-full max-w-sm h-full">
      ...
      <CardContent>
        <div className="space-y-6">
          <button onClick={createPayment} className="w-full flex items-center justify-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
            <HandCoins className="mr-2 h-5 w-5 text-gray-400" />
            Apoiar projeto
          </button>
